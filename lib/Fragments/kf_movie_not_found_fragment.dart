...
class KFMovieNotFoundComponent extends StatefulWidget {
  const KFMovieNotFoundComponent({Key? key, required this.url}) : super(key: key);
  final String url;
...
class _KFMovieNotFoundComponentState extends State<KFMovieNotFoundComponent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: kfAppBarBgColor, title:  const Text("Not found"),),
        body: Center(
      child: Column(
        ...
        children: <Widget>[
          Text(
            ...
            style: boldTextStyle(color: Colors.white,), textAlign: TextAlign.center,
          ),
          10.height,
          ElevatedButton(
