...
import 'package:kenyaflix/Components/kf_build_movie_tabs.dart';
import 'package:kenyaflix/Components/kf_build_tv_tabs.dart';

class KFMovieInformationBuilder extends StatefulWidget {
  const KFMovieInformationBuilder(
      {Key? key, required this.isMovie, required this.controller, required this.homeUrl})
      : super(key: key);
  final bool isMovie;
...
class _KFMovieInformationBuilderState extends State<KFMovieInformationBuilder> {
  ...
  Widget build(BuildContext context) {
    return isMovie
        ...
        : KFBuildTVTabs(controller: controller, isMovie: isMovie, homeUrl: widget.homeUrl,);
  }
