...
Future<Map<String, dynamic>> fetchTheIDAndPosterFromTMDB(
    {required String query, String year = '', required String type, required bool isTrailer}) async {
  try {
    ...
    if (data?.statusCode == 200) {
      ...
      if(isTrailer){
        ...
        return {
          ...
          "release_date":rootObject["first_air_date"] ?? rootObject["release_date"],
      ...
      var releaseDate = rootObject["first_air_date"] ?? rootObject["release_date"];
